...
Partial Public Class AccountLogin1DataSet
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/AccountLogin1DataSet.xsd"
...
Namespace AccountLogin1DataSetTableAdapters
    ...
    Partial Public Class AccountTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Account` WHERE ((`ID` = ?) AND ((? = 1 AND `USERNAME` IS NULL) OR (`"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Account` SET `USERNAME` = ?, `PASSCODE` = ? WHERE ((`ID` = ?) AND ((? = 1"& _ 
                " AND `USERNAME` IS NULL) OR (`USERNAME` = ?)) AND ((? = 1 AND `PASSCODE` IS NULL"& _ 
                ") OR (`PASSCODE` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, USERNAME, PASSCODE FROM Account"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT COUNT(*) FROM Account WHERE USERNAME = ? AND PASSCODE = ? "
            ...
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("PASSCODE", Global.System.Data.OleDb.OleDbType.WChar, 255, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "PASSCODE", Global.System.Data.DataRowVersion.Current, false, Nothing))
        End Sub
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As AccountLogin1DataSet.AccountDataTable, ByVal USERNAME As String, ByVal PASSCODE As String) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal USERNAME As String, ByVal PASSCODE As String) As AccountLogin1DataSet.AccountDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (USERNAME Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
